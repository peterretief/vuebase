...
//        getColumns: ['id','name', 'asset'], //types.EVENT_COLUMNS,
        getData: types.GET_ALL_EVENT_DATA,
...
this.getSelectRow = this.$store.getters["eventsById"][key]
