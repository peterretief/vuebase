...
<div class="" v-if="getSelected == 'Assets'">
  <appGridAssets>
  </appGridAssets>
</div>
...
import GridAssets from '../grid_templates/GridAssets.vue';
...
//          GET_ASSET_BY_ID: types.GET_ASSET_BY_ID
  ...
  methods: {
    ...mapMutations({
  //      mutateColumns: types.MUTATE_GET_SUB_COLUMN
    }),
    ...mapActions({
