...
<!-- <button type="button" name="button" @click='ACTION_ALL_ASSET_DATA'>pop</button> -->
...
<div class="" v-if="getSelected == 'Rentals'">
  <appGridRentals>
  </appGridRentals>
</div>
</div>
    ...
    <article class="media">
      <div class="media-content">
        <div class="content">
          ...
          <hr></hr>
          <p>
      <strong>{{$store.getters.customersById[getSelectRow.customer_id].CompanyName}}</strong>
...
import GridRentals from '../grid_templates/GridRentals.vue';
//import RentalEdit from './RentalEdit.vue';
