...
/**
      testInventory(){
//        console.log(this.$store.getters['InventoryID']);
        return this.$store.getters['InventoryID'];
      },
**/
    //  gridColumns(){
    //    return this.getColumns
//        var str = "get"+this.getSelected+"Columns"
//        str = str.trim()
//        return this.$store.getters[str]

    //  },
  //    gridData(){
  //      return this.getData
//        var str = "get"+this.getSelected+"Data"
//        str = str.trim()
//        return this.$store.getters[str]
//},
